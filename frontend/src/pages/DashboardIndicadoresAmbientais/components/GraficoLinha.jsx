...
function GraficoLinha({ celula, onLimparCelula }) {
    ...
    return (
        // Substituímos o "container-principal" padrão do componente pela classe "grafico-container" 
        // para encaixar perfeitamente na estética da página de indicadores.
        <div className="grafico-container">
            <h3 className="titulo-grafico">Tendência de Crescimento Estimado</h3>

            <div className="grafico-card" style={{ border: 'none', padding: '0', background: 'transparent' }}>
